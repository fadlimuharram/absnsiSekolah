...
<html>
    ...
    <div
        class="alert bg-green alert-dismissible animated fadeInDown"
        role="alert"
        style="display: inline-block; position: fixed; transition: all 0.5s ease-in-out 0s; z-index: 1031; bottom: 20px; right:10px;">
